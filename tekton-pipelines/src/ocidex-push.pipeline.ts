...
export interface OcidexPushPipelineProps {
  namespace: string;
  name?: string;
}

/**
 * Pipeline triggered on push events for the ocidex repo: clones the repo and
 * runs git-log to display commit state.
 *
 * Tasks:
 ...
 */
export class OcidexPushPipeline extends Construct {
  public readonly pipelineName: string;

  constructor(scope: Construct, id: string, props: OcidexPushPipelineProps) {
    super(scope, id);
    this.pipelineName = props.name ?? 'ocidex-push';
